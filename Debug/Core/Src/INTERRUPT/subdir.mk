...
Core/Src/INTERRUPT/%.o Core/Src/INTERRUPT/%.su: ../Core/Src/INTERRUPT/%.c Core/Src/INTERRUPT/subdir.mk
...
clean-Core-2f-Src-2f-INTERRUPT:
	-$(RM) ./Core/Src/INTERRUPT/interrupt.d ./Core/Src/INTERRUPT/interrupt.o ./Core/Src/INTERRUPT/interrupt.su
